<div class="container-scroller">
    ...
    <nav class="navbar col-lg-12 col-12 p-0 fixed-top d-flex flex-row">
      ...
      <a class="navbar-brand " style="width: 100px;" href="{{ route('loadingclient') }}"><img src="{{asset('images/hpower.jpeg')}}" class="mr-2" alt="logo"/></a>
      </div>
          ...
          <li class="nav-item">
            ...
            <div class="collapse" id="error">
              <ul class="nav flex-column sub-menu">
                <li class="nav-item"> <a class="nav-link" href="{{ route('loadingclient') }}">Liste Loading</a></li>
