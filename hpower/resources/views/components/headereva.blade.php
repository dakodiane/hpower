      ...
      <nav class="sidebar sidebar-offcanvas" id="sidebar">
       ...
       <!--     <li class="nav-item">
          ...
          <li class="nav-item">
            ...
            <li class="nav-item"> <a class="nav-link" href="{{ route('loadingT') }}">Liste Loading</a></li>
                <li class="nav-item"> <a class="nav-link" href="{{ route('bookingT') }}">Liste Booking</a></li>
