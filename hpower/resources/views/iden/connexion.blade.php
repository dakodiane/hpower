      ...
      <div class="card mx-4 mx-md-5 shadow-5-strong" style="
        ...
        <div class="card-body py-5 px-md-5">
          ...
          <div class="row d-flex justify-content-center">
            <div class="col-lg-8">
              <h2 class="fw-bold mb-5">Connexion <hr></h2>
              <form method="post" action="{{ route('conUser') }}">
                ...
                <div class="form-outline mb-4">
                  <input type="email" name="nom" id="form3Example3" class="form-control" />
                ...
                <!-- Submit button -->
                <br><br><button type="submit" value="connexion" class="btn btn-primary btn-block mb-4">
                  Se connecter
                </button>                
              </form>
            </div>
