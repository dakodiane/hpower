      ...
      <div class="col-12 grid-margin stretch-card">
        <div class="card">
          <div class="card-body">
            ...
            <form class="forms-sample" method="POST" action="{{ route('storefin.appro', ['approvisionnement_id' => $camions->approvisionnement_id]) }}" enctype="multipart/form-data" >
            @csrf 
